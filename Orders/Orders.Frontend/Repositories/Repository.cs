...
namespace Orders.Frontend.Repositories
{
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<T>> GetAsync<T>(string url)
        {
            ...
            {
                var response = await UnserializeAnswerAnsyc<T>(responseHttp);
        ...
        public async Task<HttpResponseWrapper<TActionResponse>> PostAsync<T, TActionResponse>(string url, T model)
        {
            ...
            if (responseHttp.IsSuccessStatusCode)
            {
                var response = await UnserializeAnswerAnsyc<TActionResponse>(responseHttp);
                return new HttpResponseWrapper<TActionResponse>(response, false, responseHttp);
            }
            return new HttpResponseWrapper<TActionResponse>(default, true, responseHttp);
        }

        private async Task<T> UnserializeAnswerAnsyc<T>(HttpResponseMessage responseHttp)
        {
